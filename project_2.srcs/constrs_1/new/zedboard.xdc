...
# set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS33} [get_ports {sys_clock}]; # "GCLK"
...
# set_property -dict {PACKAGE_PIN U21 IOSTANDARD LVCMOS33} [get_ports {leds_8bits[3]}]; # "LD3" 
# set_property -dict {PACKAGE_PIN V22 IOSTANDARD LVCMOS33} [get_ports {leds_8bits[4]}]; # "LD4" 
# set_property -dict {PACKAGE_PIN W22 IOSTANDARD LVCMOS33} [get_ports {leds_8bits[5]}]; # "LD5" 
